    ...
    <div class='panel panel-default mevn-content'>
        <div class='panel-body'>
            <div class='panel panel-info'>
                <div class='panel-body'>
                    <div v-if='!isEditing'>
                            <span v-if='$store.state.isLogin && ($store.state.user.username == article.username || $store.state.user.usertype == 1)'><a class='article-btns-right-a pull-right' title='modify article'><i class='fa fa-edit marginleftmedium' @click='editorModify'></i></a></span>
                            <span v-if='$store.state.isLogin && $store.state.user.usertype == 1'><a class='article-btns-right-a pull-right' title='Delete the article'><i class='fa fa-trash marginleftmedium' @click='deleteArticle(article._id)'></i></a></span>
...
<script>
    ...
    export default {
        ...
        computed: {
            articleSourceLink() {
                    return '<span class="marginrightsmall"><i class="fa fa-external-link marginrightsmall"></i>More info:</span><a href="' + this.article.sourcelink + '" target=_"blank">' + this.article.sourcelink + '</a>';
            },
            articleAuthorLink() {
