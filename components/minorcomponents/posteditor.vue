...
export default {
    ...
    data() {
        return {
            ...
            documenttypeList: this.preLoads === undefined ? [] : this.preLoads.documenttypeList,
            languageList: this.preLoads === undefined ? [] : this.preLoads.languageList,
    ...
    methods: {
        ...
        submitPost() {
            ...
            } else if (this.hasCategory && this.documenttype == "Documenttype") {
                this.$refs.resultView.sendMsg("Select documenttype", "error");
            } else if (this.hasCategory && this.language == "Language") {
