            ...
            <div class='post-content-editor-btns'>
                <div class="dropdown" v-if='hasCategory'>
                    ...
                    <ul class="dropdown-menu">
                        <li @click='selectCategories(category.name)' v-for='category in categoryList' v-bind:data='category' v-bind:key='category.text'>
                            <a href="javascript:void(0)">{{category.name}}</a>
                        </li>
                    </ul>
                   <ul class="dropdown-menu">
                        <li @click='selectLanguage(category.name)' v-for='category in categoryList' v-bind:data='category' v-bind:key='category.text'>
                            <a href="javascript:void(0)">{{category.name}}</a>
                        </li>
                    </ul>
                </div>
...
export default {
    ...
    computed: {
        ...
        permLink() {
            ...
            return this.catSlug + '/' + this.mainTagSlug + '/' + uniqueArray.join('-');
        }
    },
    methods: {
        categoryOnchange(cg) {
